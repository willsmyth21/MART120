    ...
    function setup() {
        ...
        for (var i = 0; i < 33; i++) {
            ...
            myshapeXs[i] = getRandomNumber(700);
            myshapeYs[i] = getRandomNumber(500);
            myshapeDiameters[i] = getRandomNumber(25);
        }
    ...
    function draw() {
        ...
        for (var i = 0; i < myshapeXs.length; i++) {
            square(myshapeXs[i], myshapeYs[i], myshapeDiameters[i]);
            myshapeXSpeeds[i] = Math.floor(Math.random() * (Math.floor(Math.random() * 5)) + 1);
            myshapeYSpeeds[i] = Math.floor(Math.random() * (Math.floor(Math.random() * 5)) + 1);
